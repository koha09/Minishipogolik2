...
gulp.task('js', function() {
	return [gulp.src([
		...
		'app/libs/bootstrap-modal/util.js',
		'app/libs/bootstrap-modal/modal.js',
		...
		gulp.src('app/libs/bootstrap-modal/modal.js')
			.pipe(uglify())
			.pipe(gulp.dest('app/js'))
			.pipe(browserSync.reload({stream: true}))
	];
...
gulp.task('build', gulp.series('removedist', 'imagemin', 'sass', 'js', 'buildFiles', 'buildCss', 'buildJs', 'buildFonts','pug'));
